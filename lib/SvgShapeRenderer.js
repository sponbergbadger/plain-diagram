...
module.exports = class SvgShapeRenderer {
  ...
  constructor(context, defaultStyles, styles, outputPath) {
  ...
  renderShape(obj, sizeAndPosition, styleBlock, svgBlock) {
    ...
    const shapeRenderer = new SvgShapeRenderer(this.context, this.defaultStyles, this.styles, this.outputPath)

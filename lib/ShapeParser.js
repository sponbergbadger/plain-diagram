...
module.exports = class ShapeParser {
  ...
  parseLayout(inputFile, params = {}, settings = this.settings, width = null, height = null, parentPathAngle = 0) {
    let result = this.parserLayout(inputFile, params, settings, width, height, parentPathAngle)
  ...
  parserLayout(inputFile, params, settings, fillToWidth = null, fillToHeight = null, parentPathAngle = 0) {

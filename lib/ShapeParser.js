...
module.exports = class ShapeParser {
  ...
  parseLayout(lines, params = {}, settings = this.settings, width = null, height = null, parentPathAngle = 0) {
    let line = lines.shift()
    let result = this.parserLayout(line, lines, params, settings, width, height, parentPathAngle)
  ...
  parserLayout(line, rem, params, settings, fillToWidth = null, fillToHeight = null, parentPathAngle = 0) {
  ...
  layoutShapeWithParams(shapeKey, params, width, height, pathAngle) {
    ...
    const layout = shapeParser.parseLayout(lines, paramsFilled, shapeLayout.settings, width, height, pathAngle)
    return layout
  }
